...
const AddPerson = () => {
  ...
  // Fetch person data for edit mode
  useEffect(() => {
    if (isEdit && id) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    setLoading(true);
    try {
      const dataToSend: PersonFormData = {
        ...formData,
        personType,
      };
      ...
      if (isEdit && id) {
        ...
        toast({
          title: 'Success',
          description: `${personType.charAt(0) + personType.slice(1).toLowerCase()} updated successfully`,
        });
      } else {
        await createPerson(dataToSend);
        toast({
          title: 'Success',
          description: `${personType.charAt(0) + personType.slice(1).toLowerCase()} created successfully`,
        });
      }
      ...
      <div className="flex items-center gap-4">
        ...
        <div>
          ...
          <p className="text-muted-foreground">
            {isEdit ? 'Update the details' : 'Fill in the details to add a new'} {personType.toLowerCase()}
          </p>
        </div>
      </div>

      <Tabs value={personType.toLowerCase()} onValueChange={value => navigate(`/people/${isEdit ? `edit/${id}` : 'add'}?type=${value}`)}>
        ...
        <TabsContent value={personType.toLowerCase()} className="mt-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div>
                    ...
                    <Input
                      ...
                      onChange={e => handleStringChange('panNumber')(e.target.value)}
                      required
                    />
                  </div>
                  <div>
                  ...
                  <div>
                    ...
                    <Input
                      ...
                      onChange={e => handleStringChange('ifscCode')(e.target.value)}
                      required
                    />
                  </div>
                  <div className="md:col-span-2">
                    ...
                    <Input
                      ...
                      onChange={e => handleStringChange('nominee')(e.target.value)}
                      required
                    />
                  </div>
                </div>
            ...
            <Card className="card-gradient">
              ...
              <CardContent className="space-y-4">
                ...
                <div>
                  ...
                  <Textarea
                    id="additionalNotes"
                    placeholder="Other comments or notes"
                    rows={3}
