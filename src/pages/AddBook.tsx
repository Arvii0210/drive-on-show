...
import { Person, Category,CategoryLabels , CoverType,CoverTypeLabels , OwnType } from "@/models/book.model";
...
year: new Date().getFullYear(),
    ...
    printRun: 0,
    price: 0,
    coverType: CoverType.PAPER_BACK,
    dimensions: "",
    weight: 0,
    reviews: "",
    awards: "",
...
const validateForm = () => {
    ...
    for (const field of requiredFields) {
      if (!bookData[field as keyof typeof bookData]) {
        toast({ title: "Fill all required fields", description: `Fill ${field}`, variant: "destructive" });
        return false;
      }
    }
    return true;
...
fieldsToRemove.forEach(key => delete payload[key]);
        ...
        <Card className="shadow bg-gradient-to-br from-white to-purple-50">
          ...
          <CardContent className="p-6 grid gap-6 md:grid-cols-2">
            ...
            <div>
              ...
              <Select value={bookData.authorId.toString()} onValueChange={(v) => handleInputChange("authorId", Number(v))} required>
                <SelectTrigger>
            ...
            <div>
              ...
              <Select value={bookData.Language} onValueChange={(v) => handleInputChange("Language", v)} required>
                <SelectTrigger>
  ...
  onValueChange={(v) => handleInputChange("category", v as Category)} required
>
  <SelectTrigger>
  ...
  <Input
    ...
    onChange={(e) => handleInputChange("editionYear", Number(e.target.value))}
    required
  />
</div>
...
<div>
  ...
  <CardContent className="p-6">
    ...
    <div className="flex flex-col md:flex-row gap-6">
      ...
      <div className="flex-1 bg-orange-50 p-4 rounded border">
        ...
        <div className="space-y-2">
          ...
          >
            ...
            <SelectContent>
              ...
              <SelectItem value={OwnType.OWN_WRITING}>Own Writing</SelectItem>
            </SelectContent>
          </Select>
        </div>
      </div>
      ...
      {bookData.ownType === OwnType.TRANSLATION && (
        <div className="flex-1 bg-blue-50 p-4 rounded border">
          ...
          <div className="space-y-2">
            ...
            >
              <SelectTrigger>
                <SelectValue
                  placeholder={loadingTranslators ? "Loading..." : "Select translator"}
                />
              </SelectTrigger>
  ...
  onValueChange={(value) => handleInputChange("coverType", value as CoverType)}
>
    ...
    {Object.values(CoverType).map((type) => (
      <SelectItem key={type} value={type}>
        ...
        <div className="flex justify-end gap-4 pt-4">
          ...
          <Button
            type="submit"
            className="bg-blue-500 hover:opacity-90 px-8"
          >
            Save Book
          </Button>
        </div>
